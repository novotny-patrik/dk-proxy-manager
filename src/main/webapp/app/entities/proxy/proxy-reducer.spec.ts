...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './proxy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROXY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROXY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROXY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROXY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROXY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROXY actions', async () => {
      const arg = 42666;
