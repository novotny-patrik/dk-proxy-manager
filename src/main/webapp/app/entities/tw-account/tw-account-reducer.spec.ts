...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TWACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TWACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TWACCOUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TWACCOUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TWACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TWACCOUNT actions', async () => {
      const arg = 42666;
